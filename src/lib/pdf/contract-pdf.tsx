...
export const ContractPDF = ({ contract, profile, platformName = 'Aranora' }: ContractPDFProps) => (
    <Document>
        <Page size="A4" style={styles.page}>
                ...
                <View style={styles.headerLeft}>
                    ...
                    <View>
                        ...
                        <Text style={styles.subtitle}>
                            {profile?.company_name || platformName} • Contract Agreement
                        </Text>
                    </View>
                </View>
                <View style={[
            ...
            <View style={styles.section}>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={styles.value}>{profile?.company_name || profile?.full_name || platformName}</Text>
                </View>
                {profile?.address && (
                    <View style={styles.row}>
            ...
            <View style={styles.footer}>
                <Text style={styles.footerText}>
                    This document was generated by {profile?.company_name || platformName}. Electronic signatures are legally binding.
                </Text>
            </View>
        </Page>
    </Document>
