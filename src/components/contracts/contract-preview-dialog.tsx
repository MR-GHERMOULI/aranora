    ...
    const handlePrint = () => {
        ...
        printWindow.document.write(`
            ...
            <body>
                ...
                <div class="footer">
                    This document was generated by ${providerName}. Electronic signatures are legally binding.
                </div>
            </body>
            </html>
        `)
                            ...
                            <div className="border-b-2 border-slate-900 dark:border-slate-200 pb-6 mb-10 flex justify-between items-end gap-6">
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400 mt-2 font-medium uppercase tracking-widest">
                                        {profile?.company_name || profile?.full_name || 'Aranora'} • Contract Agreement
                                    </p>
                                </div>
