                ...
                <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                    ...
                    <FadeIn delay={0.1} className="text-center mb-16 max-w-4xl mx-auto">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-foreground mb-6 tracking-tight leading-[1.1]">
                            Simple, <span className="bg-gradient-to-r from-brand-primary to-brand-secondary bg-clip-text text-transparent">transparent pricing</span>
                        </h1>
                        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                            Start with your first month free. No credit card required. Upgrade when you're ready to take your freelance business to the next level.
                        </p>
                    </FadeIn>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
                        ...
                        <ScaleIn delay={0.3} className={`relative rounded-3xl border-2 transition-all duration-300 ${isAnnual
                            ...
                            <div className="p-8 sm:p-10">
                                ...
                                <div className="mb-8">
                                    <div className="flex items-baseline gap-1">
                                        <span className="text-5xl font-extrabold text-foreground">$190</span>
                                    ...
                                    <p className="text-muted-foreground mt-3 text-sm flex items-center gap-2">
                                        <span className="line-through decoration-muted-foreground/50">$228/year</span>
                                        <span className="text-emerald-600 dark:text-emerald-400 font-semibold bg-emerald-500/10 px-2.5 py-0.5 rounded-md">Save 17%</span>
                                    </p>
                                </div>
